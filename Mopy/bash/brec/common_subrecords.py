...
class MelCtda(MelUnion):
    ...
    def load_data(self, record, ins, sub_type, size_, readId):
        super(MelCtda, self).load_data(record, ins, sub_type, size_, readId)
...
class MelCtdaFo3(MelCtda):
    ...
    def load_data(self, record, ins, sub_type, size_, readId):
        super(MelCtdaFo3, self).load_data(record, ins, sub_type, size_, readId)
...
class MelRaceParts(MelNull):
    ...
    def load_data(self, record, ins, sub_type, size_, readId,
        ...
        if sub_type == 'INDX':
            ...
            self._indx_to_loader[self._last_indx].load_data(

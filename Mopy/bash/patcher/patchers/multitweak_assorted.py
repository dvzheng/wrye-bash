...
class AAssortedTweak_HarvestChance(_AAssortedTweak):
    ...
    def wants_record(self, record):
        return (not _is_nirnroot(record) # skip Nirnroots
...
class AssortedTweak_GunsUseISAnimation(MultiTweakItem):
    ...
    def wants_record(self, record):
        return (record.etype in self.choiceValues[self.chosen][0] and
...
class AssortedTweaker(MultiTweaker):
    ...
    scanOrder = 32
    editOrder = 32
    _tweak_classes = [globals()[tweak_name] for tweak_name
                      in bush.game.assorted_tweaks]
...
class CBash_AssortedTweaker(CBash_MultiTweaker):
    ...
    _tweak_classes = [
        ...
        CBash_AssortedTweak_ClothingPlayable, CBash_AssortedTweak_BowReach,
        CBash_AssortedTweak_ConsistentRings, CBash_AssortedTweak_DarnBooks,
        CBash_AssortedTweak_FogFix, CBash_AssortedTweak_NoLightFlicker,
        ...
        CBash_AssortedTweak_HarvestChance, CBash_AssortedTweak_WindSpeed,
        CBash_AssortedTweak_UniformGroundcover,
        CBash_AssortedTweak_IngredientWeight, CBash_AssortedTweak_ArrowWeight,
        ...
        CBash_AssortedTweak_TextlessLSCRs, CBash_AssortedTweak_SEFFIcon,
    ]

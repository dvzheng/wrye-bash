...
from ...brec import MelRecord, MelGroups, MelStruct, FID, MelGroup, \
    MelString, MelSet, MelFid, MelOptStruct, MelFids, MelBase, BipedFlags, \
...
class MreArma(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelBounds(),
        MelFull(),
        MelStruct(b'BMDT', u'=2I', (_flags, u'biped_flags'),
...
class MreArmo(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'BMDT', u'=IB3s', (_flags, u'biped_flags'),
                  (_generalFlags, u'generalFlags'), (u'armoBMDT1', null3)),
        MelModel('maleBody'),
        MelModel('maleWorld',2),
        MelIcons('maleIconPath', 'maleSmallIconPath'),
        MelModel('femaleBody',3),
...
class MreWthr(MelRecord):
    ...
    class MelWthrColorsFnv(MelArray):
        ...
        #  get_entry_size that receives the total size_ of load_data.
        ...
        def load_data(self, record, ins, sub_type, size_, readId):
            if size_ == self._new_sizes[sub_type]:
                MelArray.load_data(self, record, ins, sub_type, size_, readId)
                ...
                load_entry = self._element_old.load_data

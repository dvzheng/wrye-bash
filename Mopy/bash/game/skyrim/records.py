...
class MreMgef(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelPartialCounter(MelStruct(
            ...
            u'dual_casting_scale', (FID, u'enchant_art'), (FID, u'unknown2'),
            (FID, u'unknown3'), (FID, u'equip_ability'),
            (FID, u'effect_imad'), (FID, u'perk_to_apply'),
            u'casting_sound_level', u'script_effect_ai_score',
            u'script_effect_ai_delay_time'),

...
__all__ = [u'Mod_FullLoad', u'Mod_CreateDummyMasters', u'Mod_OrderByName',
           ...
           u'Mod_ExportPatchConfig', u'CBash_Mod_CellBlockInfo_Export',
           u'Mod_EditorIds_Export', u'Mod_FullNames_Export',
           u'Mod_Prices_Export', u'Mod_Stats_Export', u'Mod_Factions_Export',
           u'Mod_ActorLevels_Export', u'Mod_Redate',
           ...
           u'Mod_EditorIds_Import', u'Mod_FullNames_Import',
           u'Mod_Prices_Import', u'Mod_Stats_Import', u'Mod_Factions_Import',
           u'Mod_ActorLevels_Import', u'CBash_Mod_MapMarkers_Import',
           ...
           u'Mod_FogFixer', u'Mod_CopyToEsmp', u'Mod_DecompileAll',
...
class Mod_JumpToInstaller(AppendableLink, OneItemLink):
    ...
    def _initData(self, window, selection):
        ...
        self._help = _(u'Jump to the installer of %(filename)s if it exists. '
                       ...
                       u'effect.') % {u'filename': selection[0]}
    ...
    def Execute(self):
        ...
        if len(self.selected) == 1:
            ...
            if not self.isGhost: # ghosting - override allowGhosting with True
                bosh.modInfos.table.setItem(self.mname, u'allowGhosting', True)
        ...
        if bush.game.check_esl:
            ...
            self._help = _(
                ...
                u'also the reason they are unmergeable') % {
                    u'patch_type': _(u'Cbash') if doCBash else _(u'Python')}
    ...
    def Execute(self):
        ...
        for index, (fileName, fileInfo) in enumerate(self.iselected_pairs()):
            ...
            with balt.Progress(_(u'Remove World Orphans')) as progress:
                ...
                orphans = (b'WRLD' in modFile.tops) and modFile.WRLD.orphansSkipped
                if orphans:
...
class CBash_Mod_MapMarkers_Import(_Mod_Import_Link, _CBash_Link):
    ...
    continueInfo = _(
        ...
        u'not reversible!')
    continueKey = u'bash.MapMarkers.import.continue'
